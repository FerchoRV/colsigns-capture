        ...
        <ProtectedRoute allowedRoles={[parseInt(process.env.NEXT_PUBLIC_APP_ROLE_1)]}>
            <main className="flex min-h-screen flex-col p-6">
                ...
                <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
                    ...
                    <p>
                        <strong>Administrar videos de ejemplo de signos colombianos, </strong> esta seccion permite administrar los videos de ejemplo de la aplicacion para realziar la captura de datos {' '}
                    </p>
                    <Link
