...
export default function HelpPage() {
  return (
    <div className="p-6">
      ...
      <br />
      <p className="text-gray-700">Esta iniciativa espera entregar una solución que apoye los procesos de comunicación entre personas sordas y oyentes sin conocimiento en lenguaje de signos, además de hacer conciencia que para una inclusión social de personas sordas debemos interesarnos en este mecanismo de comunicación.</p>
      <br />
      <p className="text-gray-700">Y todos pueden ser parte inicialmente en la captura de datos para entrenar modelos de inteligencia artificial ya que se quiere mejorar la capacidad actual de los modelos y estos se consigue con grandes cantidades de información representativa de signos colombianos, para esto puedes seguir los siguientes pasos:</p>
      <br />
      ...
      <br />
      <p className="text-gray-700">5. En esta interfaz debes seleccionar el signo que deseas enviar para esto primero selecciona el tipo de signos que pueden ser caracteres (abecedario-números del 0 al 9), palabras (signos que representa una sola palabra), frases (signos que representan dos o más palabras o expresiones como “a veces”, “muchas gracias”, “buenos días”):</p>
      <br />
      <div className="flex justify-center">
        <Image
      ...
      <br />
      <p className="text-gray-700">7. De la lista de signos que te entregue el sistema debes elegir uno y darle clic sobre él, esto te permitirá acceso al módulo de grabar y de ver ejemplo del signo seleccionado como se ve en la siguiente imagen; se recomienda ver el ejemplo del signo para personas sin experiencia en estos, y practiquen antes de enviar el signos y cuando estén listo hacer su respectiva contribución, para ver el ejemplo solo debes presionar el botón Ver Ejemplo, y para grabar oprimes el botón Encender Cámara, este pedirá permisos para acceder a tu cámara presionar permitir y puedes empezar a grabar. </p>
      <br />
      <div className="flex justify-center">
        <Image
      ...
      <br />
      <p className="text-gray-700">Con esto puede ser arte de esta iniciativa y quien sabe y aprendas algunos lenguajes de signos, todos los videos de ejemplo proporcionados cuentan con un enlace directo al creador por si requieren mas información sobre el lenguaje de signos colombiano. Si deseas contribuir de otra manera no dudes en ponerte en contacto con nosotros por medio del correo 
        {' '}
                <a
