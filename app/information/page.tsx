...
export default function GeneralPage() {
  return (
    <div className="p-6">
      ...
      <br />
      <p className="text-gray-700">Todo surge de una simple pregunta en el 2022, ¿Cómo me puedo comunicar con una persona sorda sin saber lenguaje de signos?, esta pregunta se llevó a un entorno de investigación por parte del Ingeniero Diego Fernando Rivera Vasquez, en donde se identifico la posibilidad de desarrollar interprete de lengua de signos para el contexto colombiano implementando técnicas de inteligencia artificial, visión artificial e ingeniería de software, esta posibilidad se adoptó como trabajo de grado para optar por el título de Magister en computación en la Universidad del Cauca.</p>
      <br />
      <h1 className="text-2xl font-bold text-blue-500">¿Qué se ha conseguido hasta ahora?</h1>
      <br />
      <p className="text-gray-700">Principal mente se ha conseguido experimentar con técnicas de inteligencia artificial para generar modelos de reconocimiento de signos colombianos, se han conseguido modelos con hasta el 90% de precisión para identificar en promedio 28 signos independientes, tanto para signos estáticos como es el abecedario y dinámicos como son los signos que representan palabras, como se ve a continuación:</p>
      <br />
      <div className="flex flex-col items-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 justify-center items-center">
          ...
          <div className="flex flex-col items-center">
            ...
            />
            <p className="mt-2 text-gray-700 text-center">Reconocimiento de signos estáticos(Abecedario)</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            <Image
              ...
              className="w-3/4 h-auto rounded-lg shadow-lg"
            />            
            <p className="mt-2 text-gray-700 text-center">Reconocimiento de signos dinámicos(Palabras)</p>
          </div>
        </div>
      </div>
      <br />
      <p className="text-gray-700">
        ...
        <a href="https://github.com/FerchoRV/LSTM-Reconocimiento-de-signos-colombianos" className="text-blue-500 underline" target="_blank" rel="noopener noreferrer">
          aquí
        </a>
      </p>
      <br />
      ...
      <br />
      <p className="text-gray-700">Se espera conseguir un modelo de reconocimiento de signos colombianos capaz de reconocer al menos los 100 signos fundamentales para una conversación, que permita desarrollar una herramienta que facilite la comunicación entre personas sordas y oyentes, además de proveer a la comunidad científica un conjunto de datos como mas de 500 signos colombianos para quienes les interés entrenar estrategias de inteligencia artificial y generar sus propios modelos.</p>
      <br />
      <h1 className="text-2xl font-bold text-blue-500">¿Qué se está haciendo actualmente?</h1>
      <br />
      <p className="text-gray-700">En la actualidad se esta haciendo la captura de datos para entrenar estrategias de inteligencia artificial, la meta es almacenar la información de mas de 500 signos colombianos por medio de videos que se comparte por medio de esta plataforma, además de que se va experimentando con los datos capturados para ir generando modelos con mayor capacidad de reconocimiento, junto a esto se está desarrollando un PMV llamado Colsign Interprete para validar el comportamiento de los modelos en un entorno real. </p>
      <br />
