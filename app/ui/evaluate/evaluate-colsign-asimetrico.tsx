      ...
      <div className="p-4">
        ...
        <div className="mb-8">
          <h2 className="text-xl text-gray-800 mb-4">
            El modelo de señas dinamicas asimetricas fue entrenado con señas basicas que se realizan con ambas manos y movimientos asimetricos o diferentes por mano, debes 
