...
const LABELS_URL = "/info_models/colsign_lstm_norm_bi_simetrico_45_154_labels.json";
const PAGE_SIZE = 25;

interface LabelsColsignBiSimetricoProps {
  onLetterSelect: (label: string, signType?: string) => void;
  selectedLetter?: string | null;
  signType?: string;
}
export default function LabelsColsignBiSimetrico({
  onLetterSelect,
  selectedLetter,
  signType,
}: LabelsColsignBiSimetricoProps) {
