...
const LABELS_URL = "/info_models/colsign_lstm_norm_estatic_45_154_v2_labels.json";
const PAGE_SIZE = 25;

interface LabelsColsignStaticV2Props {
  onLetterSelect: (label: string, signType?: string) => void;
  selectedLetter?: string | null;
  signType?: string;
}
export default function LabelsColsignStaticV2({
  onLetterSelect,
  selectedLetter,
  signType,
}: LabelsColsignStaticV2Props) {
