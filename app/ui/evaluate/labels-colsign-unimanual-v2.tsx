...
const LABELS_URL = "/info_models/colsign_lstm_norm_unimanual_45_154_v2_labels.json";
const PAGE_SIZE = 25;

interface LabelsColsignUnimanualV2Props {
  onLetterSelect: (label: string, signType?: string) => void;
  selectedLetter?: string | null;
  signType?: string;
}

export default function LabelsColsignUnimanualV2({
  onLetterSelect,
  selectedLetter,
  signType,
}: LabelsColsignUnimanualV2Props) {
