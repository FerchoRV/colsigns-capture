"use client";
import LabelsColsignBiSimetrico from "./labels-colsign-simetrico";
...
// Endpoint del nuevo modelo Colsign (simetrico)
const COLSIGN_API_BASE = "https://colsign-api-models-244204625992.europe-west1.run.app/api/v1";
const COLSIGN_TEST_ENDPOINT = `${COLSIGN_API_BASE}/test/simetrico`;
...
// Respuesta del endpoint /api/v1/test/simetrico
...
const EvaluateColsignBiSimetrico: React.FC = () => {
    ...
    >
      <div className="p-4">
        <h1 className="text-3xl font-extrabold text-blue-500 mb-6">
          Evalúa el modelo de señas dinamicas simetricas
        </h1>
...
export default EvaluateColsignBiSimetrico;