"use client";
import LabelsColsign45154 from "@/app/ui/evaluate/labels-colsign-45-154";
...
// Endpoint del nuevo modelo Colsign (plano)
const COLSIGN_API_BASE = "https://colsign-api-models-244204625992.europe-west1.run.app/api/v1";
const COLSIGN_TEST_ENDPOINT = `${COLSIGN_API_BASE}/test/plano`;
...
// Respuesta del endpoint /api/v1/test/plano
...
const EvaluateColsign45154: React.FC = () => {
    ...
    >
      <div className="p-4">
        <h1 className="text-3xl font-extrabold text-blue-500 mb-6">
          Evalúa señas del modelo Colsign (154 clases)
        </h1>
...
export default EvaluateColsign45154;
