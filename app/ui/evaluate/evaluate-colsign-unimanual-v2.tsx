"use client";
import LabelsColsignUnimanualV2 from "./labels-colsign-unimanual-v2";
...
// Endpoint del nuevo modelo Colsign (unimanual)
const COLSIGN_API_BASE = "https://colsign-api-models-244204625992.europe-west1.run.app/api/v1";
const COLSIGN_TEST_ENDPOINT = `${COLSIGN_API_BASE}/test/unimanual`;
...
// Respuesta del endpoint /api/v1/test/unimanual
...
const EvaluateColsignUnimanualV2: React.FC = () => {
    ...
    >
      <div className="p-4">
        <h1 className="text-3xl font-extrabold text-blue-500 mb-6">
          Evalúa el modelo de señas dinamicas unimanuales
        </h1>
...
export default EvaluateColsignUnimanualV2;
