"use client";
import LabelsColsignStaticV2 from "./labels-colsign-static-v2";
...
// Endpoint del nuevo modelo Colsign (static)
const COLSIGN_API_BASE = "https://colsign-api-models-244204625992.europe-west1.run.app/api/v1";
const COLSIGN_TEST_ENDPOINT = `${COLSIGN_API_BASE}/test/static`;
...
// Respuesta del endpoint /api/v1/test/static
...
const EvaluateColsignStatic: React.FC = () => {
    ...
    >
      <div className="p-4">
        <h1 className="text-3xl font-extrabold text-blue-500 mb-6">
          Evalúa el modelo de señas estaticas
        </h1>
...
export default EvaluateColsignStatic;